...
1.Predict loan approval status (Approved / Rejected)
2.User-friendly web interface
3.Real-time prediction using FastAPI backend
4.Integration of Pydantic for data validation
5.Handles missing and categorical data effectively 

Dataset

The project uses a dataset containing applicant information like:
...
Dataset can be found in app/dataset/loan_data.csv
